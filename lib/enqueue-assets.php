...
function cvstart_scripts() {
	...
	wp_enqueue_style( 'cvstart-custom-googlefont', '//fonts.googleapis.com/css?family=Roboto+Condensed:300,300i,400,400i,700,700i|Roboto:100,300,400,400i,700,700i', array(), time(), 'all' );
	
	wp_enqueue_style( 'cvstart-fontawsome', '//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), time(), 'all' );
